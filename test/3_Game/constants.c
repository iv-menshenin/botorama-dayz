...
static const string DM_CHAT_TEST_BANDAGING = "bandaging";
static const string DM_CHAT_TEST_SPLINTING = "splinting";
static const string DM_CHAT_TEST_PAINKILLER = "painkiller";
static const string DM_CHAT_TEST_PAINKILLER_BANDAGE = "painkillerbandage";
static const string DM_CHAT_TEST_CHARCOAL = "charcoal";
static const string DM_CHAT_TEST_TETRACYCLINE = "tetracycline";
static const string DM_CHAT_TEST_VITAMINS = "vitamins";
