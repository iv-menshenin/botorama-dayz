...
class CfgMods 
{
	class dmBotorama_Core
	{
		...
		author = "devalio";
		type = "mod";
		defines[] = { "DM_BOT_PROFILE", "DM_BOT_DEBUG_FSM", "DM_WEAPON_DEBUG_FSM", "DM_BOT_DEBUG_SPAWN", "DM_BOT_DEBUG_BODY", "DM_BOT_DEBUG_CAR", "DM_BOT_DEBUG_DRIVE_TELEMETRY", "DM_BOT_DEBUG_LOOTING" };
		class defs 
		{
