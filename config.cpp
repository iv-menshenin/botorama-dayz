...
class CfgMods 
{
	class dmBotorama
	{
		...
		version = 2.4;
		type = "mod";
		defines[] = { "DM_BOT_PROFILE", "DM_BOT_DEBUG_LOOTING", "DM_BOT_DEBUG_BODY", "DM_WEAPON_DEBUG_FSM", "DM_BOT_DEBUG_PATHFINDER", "DM_BOT_DEBUG_BALLISTICS", "DM_BOT_DEBUG_FSM", "DM_BOT_DEBUG_VISION", "DM_PERCEPTION_DEBUG" };	
		class defs 
		{
